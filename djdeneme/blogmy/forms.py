...
banned_email_list = ['ahmet@gmail.com' , 'deneme@hotmail.com' , 'ugurdurak52@gmail.com']
...
class PostSorguForm(forms.Form):
    ...
    search = forms.CharField(required=False , max_length=500 , widget=forms.TextInput(attrs={'placeholder' :'bir şey ara' ,'class' : 'form-control','id':'searchfield'}))
